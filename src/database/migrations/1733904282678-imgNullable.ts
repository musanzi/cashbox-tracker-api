...
export class ImgNullable1733904282678 implements MigrationInterface {
  name = 'ImgNullable1733904282678';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`venture\` CHANGE \`image\` \`image\` varchar(255) NOT NULL`);
    await queryRunner.query(
