...
export class AddIspublished1733737701663 implements MigrationInterface {
  name = 'AddIspublished1733737701663';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX \`FK_8d5525f4acba6e2149fb5da4a8c\` ON \`review\``);
    await queryRunner.query(`DROP INDEX \`FK_bea8f7bc6860508ea240f4725ab\` ON \`review\``);
    await queryRunner.query(`DROP INDEX \`FK_cf336e5a3d2e9c4448abbfa594c\` ON \`application\``);
    await queryRunner.query(`DROP INDEX \`FK_b4ae3fea4a24b4be1a86dacf8a2\` ON \`application\``);
    await queryRunner.query(`DROP INDEX \`FK_ed3de91a28a36881c5e90283fdd\` ON \`requirement\``);
    await queryRunner.query(`DROP INDEX \`FK_f2bf8d12e931bb9eee1ec1e9975\` ON \`document\``);
    await queryRunner.query(`DROP INDEX \`FK_a251d108b40a8021a4359caeb7e\` ON \`phase\``);
    await queryRunner.query(`DROP INDEX \`FK_e195b4c478ace2cf124c13ed11e\` ON \`event\``);
    await queryRunner.query(`ALTER TABLE \`venture\` ADD \`is_published\` tinyint NOT NULL DEFAULT 0`);
    await queryRunner.query(`ALTER TABLE \`program\` ADD \`is_published\` tinyint NOT NULL DEFAULT 0`);
    await queryRunner.query(`ALTER TABLE \`event\` ADD \`is_published\` tinyint NOT NULL DEFAULT 0`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`event\` DROP COLUMN \`is_published\``);
    await queryRunner.query(`ALTER TABLE \`program\` DROP COLUMN \`is_published\``);
    await queryRunner.query(`ALTER TABLE \`venture\` DROP COLUMN \`is_published\``);
    await queryRunner.query(`CREATE INDEX \`FK_e195b4c478ace2cf124c13ed11e\` ON \`event\` (\`responsibleId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_a251d108b40a8021a4359caeb7e\` ON \`phase\` (\`programId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_f2bf8d12e931bb9eee1ec1e9975\` ON \`document\` (\`programId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_ed3de91a28a36881c5e90283fdd\` ON \`requirement\` (\`phaseId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_b4ae3fea4a24b4be1a86dacf8a2\` ON \`application\` (\`userId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_cf336e5a3d2e9c4448abbfa594c\` ON \`application\` (\`programId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_bea8f7bc6860508ea240f4725ab\` ON \`review\` (\`reviwerId\`)`);
    await queryRunner.query(`CREATE INDEX \`FK_8d5525f4acba6e2149fb5da4a8c\` ON \`review\` (\`applicationId\`)`);
  }
}
