...
export class PitchlongText1733997514084 implements MigrationInterface {
  name = 'PitchlongText1733997514084';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`venture\` DROP COLUMN \`pitch\``);
    await queryRunner.query(`ALTER TABLE \`venture\` ADD \`pitch\` text NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`venture\` DROP COLUMN \`pitch\``);
    await queryRunner.query(`ALTER TABLE \`venture\` ADD \`pitch\` varchar(255) NOT NULL`);
